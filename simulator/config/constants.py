...
MQTT_ACK_WIRE_BYTES: int = TCP_TRANSPORT_OVERHEAD + MQTT_ACK_BYTES
COAP_ACK_WIRE_BYTES: int = UDP_TRANSPORT_OVERHEAD + COAP_ACK_BYTES
AMQP_ACK_WIRE_BYTES: int = TCP_TRANSPORT_OVERHEAD + AMQP_ACK_FRAME
