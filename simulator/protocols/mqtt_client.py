...
from simulator.constants import (
    MQTT_CONTROL_BYTE, MQTT_PACKET_ID_BYTES, MQTT_TOPIC_LEN_BYTES,
    MQTT_ACK_BYTES, TCP_TRANSPORT_OVERHEAD,
)
...
class SimulatedMQTTBackend(ProtocolBackend):
    ...
    def __init__(self, config: MQTTConfig, clock: SimClock, subscriber_cb: CloudRecvCallback,
