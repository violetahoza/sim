...
from simulator.constants import (
    AMQP_FRAME_ENVELOPE, AMQP_PUBLISH_METHOD_FIXED,
    AMQP_CONTENT_HEADER_FIXED, AMQP_PROPERTY_TABLE_EST,
...
class SimulatedAMQPBackend(ProtocolBackend):
    ...
    def __init__(self, config: AMQPConfig, clock: SimClock, subscriber_cb: CloudRecvCallback,
                 loss_rate: float = 0.01, seed: int = 0,
