...
def make_cfg_from_body(name: str, body: dict) -> ScenarioConfig:
    ...
    return make_scenario(
        ...
        num_spots = num_spots,
        loss_rate = max(0.0, min(0.5, float(body.get("loss_rate", 0.05)))),
        backhaul_loss_rate = max(0.0, min(0.2, float(body.get("backhaul_loss_rate", 0.02)))),
        ...
        max_payload_bytes = int(body.get("max_payload_bytes", 222)),
